...
let operations = plan.operations.filter(selectOperation);
{
  ...
  const eccContentDestination = (source, destination) => {
    ...
    const mapping = (() => {
      ...
      const mappings = [[".agents/plugins/", ".agents/plugins/"], [".agents/skills/", ".agents/skills/"], ...(payload.target === "claude" ? [[".claude/commands/", ".claude/commands/"]] : []), ...(payload.target === "opencode" ? [["skills/", ".agents/skills/"]] : [["agents/", targetRoot + "/agents/"], ["skills/", targetRoot + "/skills/"], ["commands/", targetRoot + "/commands/"], ["rules/", targetRoot + "/rules/"]])];
