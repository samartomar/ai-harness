...
The current release baseline is `@aihq/harness@5.2.1`. The `vibe`/`enterprise` model below is shipped behavior in the 5.x line; use the installed version's release notes and CLI help as the syntax authority.
