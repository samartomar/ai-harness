...
Release baseline covered by this guide: `@aihq/core@0.3.0`; the frozen,
...
`@aihq/scan@0.1.4` is public with matching npm, GitHub Release, and provenance
evidence. Install that exact version into a disposable consumer:

```bash
npm install --save-dev @aihq/scan@0.1.4
...
code-owned adapter. Its source repository and exact `@aihq/scan@0.1.4` npm package are public.
