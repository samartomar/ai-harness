...
| Verify a published release | `aih verify-release` or `aih verify-release <version>` | Install origin, npm signatures, checksums, cosign bundle, release artifacts, and tarball hash need verification. |
