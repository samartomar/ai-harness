...
- `ai-coding/rules/project-canon-extension.md` — repo-specific rules (environment, git/CI, review, engine invariants, product principles, doc homes); load the slice your task touches
