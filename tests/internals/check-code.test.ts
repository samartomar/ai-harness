...
describe("Check.code — invariants", () => {
  ...
  it("wires every CheckCode union member to a real emitter (excl. verify.ts)", () => {
    ...
    const present: Record<CheckCode, true> = {
      ...
      "org-policy.dropped-target-unowned": true,
      "org-policy.generation-delta": true,
      "org-policy.invalid": true,
      "org-policy.bundle-invalid": true,
      "org-policy.effective-blocked": true,
      "org-policy.observe-input-invalid": true,
      "org-policy.observe-evidence-invalid": true,
      "org-policy.observe-evidence-changed": true,
      "org-policy.observe-authority-unverified": true,
      "org-policy.observe-authority-not-current": true,
      "org-policy.observe-decision-mismatch": true,
      "org-policy.observe-decision-rejected": true,
      "org-policy.observe-decision-revoked": true,
      "org-policy.observe-decision-not-current": true,
      "org-policy.observe-decision-scope-mismatch": true,
      "org-policy.observe-qualification-unverified": true,
      "org-policy.observe-installed-evidence-unavailable": true,
      "org-policy.observe-installed-evidence-invalid": true,
      "org-policy.observe-installed-evidence-changed": true,
      "org-policy.observe-installed-identity-mismatch": true,
      "org-policy.observe-invariant-violation": true,
      "org-policy.observe-artifact-decision-revoked": true,
      "org-policy.observe-artifact-identity-mismatch": true,
      "org-policy.lifecycle-input-invalid": true,
      "org-policy.lifecycle-authority-unverified": true,
      "org-policy.lifecycle-decision-revoked": true,
      "org-policy.lifecycle-artifact-decision-revoked": true,
      "org-policy.lifecycle-observation-invalid": true,
      "org-policy.lifecycle-store-invalid": true,
      "org-policy.lifecycle-store-conflict": true,
      "org-policy.resolve-input-invalid": true,
      "org-policy.resolve-evidence-invalid": true,
      "org-policy.resolve-authority-blocked": true,
      "org-policy.resolve-observation-missing": true,
      "bundle.signature": true,
      "report.context-over-budget": true,
      "report.low-adoption": true,
      "report.contract-untrue": true,
      "docs.banned-phrase": true,
      "docs.vague-absolute": true,
      "docs.unsupported-callout-claim": true,
      "docs.rules-missing": true,
      "docs.claim-mapping-missing": true,
      "docs.claim-matrix-row-missing": true,
      "docs.claim-test-missing": true,
      "docs.feature-ledger-drift": true,
      "truth.sidecar-missing": true,
      "truth.bound-commit-drift": true,
      "truth.version-drift": true,
      "truth.claim-matrix-row-missing": true,
      "truth.decision-supersession-missing": true,
      "truth.acceptance-blocked-environment": true,
      "truth.acceptance-blocked-vendor-specific": true,
      "truth.agent-evidence-mismatch": true,
      "truth.pack-invalid": true,
      "ready.blocked": true,
      "baseline.registry-missing": true,
      ...
      "trust.fetch-metadata-unreadable": true,
      "trust.fetch-metadata-malformed": true,
      "trust.fetch-metadata-mismatched": true,
