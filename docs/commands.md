...
other platforms, all filesystem intent reads, including otherwise-unreadable paths, fail
closed with exit `3` until an equivalent descriptor-anchored, no-follow traversal is
