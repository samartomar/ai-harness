...
| `npm run test:workbench:pr` | 47.737 s; 87 pure tests, 263 retained tests, 7 Chromium journeys passed |
| Pure stage with coverage | 3.421 s; below 10 s |
| Peak summed resident memory in Workbench lane | 2,348,838,912 bytes; no heap override |
