...
| Go module | watch | good | good | good | good | good | good | good | good | Go module coverage detects Gin, DB drivers, golangci-lint, go modules, and go.work workspace detail. |
| Java Maven | watch | good | good | good | good | good | good | good | good | Maven coverage detects Spring Boot, DB drivers, checkstyle, package manager, and reactor workspace detail. |
| .NET | watch | good | good | good | good | good | good | good | good | .NET coverage detects ASP.NET Core, EF Core, DB providers, dotnet format, package manager, and solution detail. |
...
- `go-module`: lang=Go; fw=Gin; test=go test ./...; build=go build ./...; lint=golangci-lint run; db=PostgreSQL+Redis; pm=go modules; workspace=go workspace
- `java-maven`: lang=Java/Maven; fw=Spring Boot; test=mvn test; build=mvn clean package; lint=mvn checkstyle:check; db=PostgreSQL; pm=maven; workspace=maven
- `dotnet`: lang=.NET; fw=ASP.NET Core+Entity Framework Core; test=dotnet test; build=dotnet build; lint=dotnet format --verify-no-changes; db=PostgreSQL+Redis; pm=dotnet; workspace=dotnet solution
