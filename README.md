...
<p align="center">
  <img src="docs/assets/aih-overview.svg" alt="aih v5.0.0 governed-readiness overview showing Environment, Context, Policy, Execution, and Evidence pillars plus truth verify and the docs-lint claim gate" width="100%">
</p>
...
```bash
npm install -g @aihq/harness@5.0.0      # then run: aih --help
aih verify-release 5.0.0   # checks npm signatures, GitHub release sums, and cosign evidence for 5.0.0
```
...
| [`aih capability`](docs/commands.md#aih-capability) | Resolve repo capability needs and inspect/preview policy-driven package reconciliation from exact local authority bytes. |
