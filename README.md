...
| [`aih repair`](docs/commands.md#aih-repair) | Preview the one local Governance Doctor mechanical repair; the shipped all-or-nothing mapping is intentionally inert and current real runs yield no plan, while the closed `--apply` route is reserved for an eligible plan and TTY digest confirmation. <!-- aih:claim CM-74 --> |
