...
<p align="center">
  <img src="docs/assets/aih-overview.svg" alt="aih v2.4.2 governed-readiness overview showing Environment, Context, Policy, Execution, and Evidence pillars plus truth verify and the docs-lint claim gate" width="100%">
</p>
