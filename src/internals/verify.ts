...
export type CheckCode =
  ...
  // Sealed npm upstream-observation failures. These intentionally never reuse
  // policy-resolve codes: the observer has different evidence and remediation
  // ownership from a caller-requested resolution.
