"use strict";
// The one chrome-devtools-mcp opt-out predicate (see src/ecc/codex.ts). aih loads
// this file by its absolute path from its own installation twice: in process at
