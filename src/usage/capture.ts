...
export function usageRecorderScript(): string {
  return lines(
    ...
    '    ev.kind = "skill"; ev.name = str(ti.subagent_type, ti.subagentType, ti.agent_name, ti.agentName, ti.agent, ti.name, p.subagent_type, p.subagentType, "subagent");',
    ...
    "  const explicit = str(ti.source, ti.provenance, p.source, p.provenance);",
