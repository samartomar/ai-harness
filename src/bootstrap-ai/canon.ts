...
function ruleRouterLegacy(
  ...
  return lines(
    ...
    "For large repos, verify `large-repo graph safety` with `aih doctor`. If",
    "code-review-graph is unavailable, errors, or has no populated graph, stop;",
    "repair it and verify a populated graph before continuing.",
    "",
    "### Code review / PR",
