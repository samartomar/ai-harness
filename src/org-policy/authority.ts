...
const RECEIPT_EVIDENCE_CONSUMERS: Readonly<Record<string, string>> = {
  ...
  "detectors.*.required": "authority resolver: mandatory detector evidence-problem label",
  "detectors.*.status": "authority resolver: mandatory detector evidence-problem label",
  evidenceDigest: "authority resolver: exact approval and evidence binding",
  "findings.*": "authority resolver: finding labels carried with the evidence",
