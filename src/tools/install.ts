...
export const TOOLS: ToolSpec[] = [
  ...
  },
  {
    ...
    // bump in lockstep. PEP 508 `==` form — pip/uv reject the uvx `@2.3.7` shorthand.
    options: [
      { pm: "uv", argv: ["uv", "tool", "install", "code-review-graph==2.3.7"] },
      { pm: "pip", argv: ["pip", "install", "code-review-graph==2.3.7"] },
    ],
    manual: "pip install code-review-graph==2.3.7",
  },
];
