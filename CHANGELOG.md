...
- Native trust scanning now indexes line locations once and uses bounded exact-finding identity
  input for oversized untrusted lines, preventing quadratic many-finding scans while preserving
  ordinary finding fingerprints and the blocking danger floor. (#448)
