...
- Capability Package Manager lifecycle state can now be projected into an
  ...
  receipt. The planner binds exact live bytes and modes, orders intent before
  receipt on writes and receipt before intent on final removal, and refuses
  malformed or unsafe state. It exposes no commit API and does not install,
  configure, adopt, remove, or claim ownership of package members.
...
[Unreleased]: https://github.com/samartomar/ai-harness/compare/v5.0.0...HEAD
